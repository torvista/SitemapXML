...
define('CFGDESC_SITEMAPXML_VERSION', '');
...
define('TEXT_IMAGE_SUBMIT', 'Create Sitemap\'s');
define('TEXT_IMAGE_SAVE', 'SAVE SETTINGS');
define('TEXT_SAVE_SETTINGS', '<b>NOTE: </b> Save your selection to the database.  The selection in the database is used to create new xml feeds.');
define('TEXT_SUBMIT_NOTE', '<b>NOTE: </b> No Selection, changes added to existing files or created. Select REBUILD option to re-create or make new feeds. Select PING option to request a visit from search engines.');
